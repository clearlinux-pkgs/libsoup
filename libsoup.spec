...
Source0  : https://download.gnome.org/sources/libsoup/2.64/libsoup-2.64.2.tar.xz
...
BuildRequires : pkgconfig(32libpsl)
...
%prep
%setup -q -n libsoup-2.64.2
pushd ..
cp -a libsoup-2.64.2 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1540226646
export AR=gcc-ar
