...
Source0  : https://download.gnome.org/sources/libsoup/3.0/libsoup-3.0.5.tar.xz
...
%prep
%setup -q -n libsoup-3.0.5
cd %{_builddir}/libsoup-3.0.5
pushd ..
cp -a libsoup-3.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647642613
...
cp %{_builddir}/libsoup-3.0.5/COPYING %{buildroot}/usr/share/package-licenses/libsoup/ba8966e2473a9969bdcab3dc82274c817cfd98a1
