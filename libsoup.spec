...
Source0  : https://download.gnome.org/sources/libsoup/2.64/libsoup-2.64.1.tar.xz
...
%prep
%setup -q -n libsoup-2.64.1
pushd ..
cp -a libsoup-2.64.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1537810599
export AR=gcc-ar
