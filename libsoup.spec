...
Source0  : https://download.gnome.org/sources/libsoup/2.58/libsoup-2.58.1.tar.xz
...
%prep
%setup -q -n libsoup-2.58.1
pushd ..
cp -a libsoup-2.58.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1494338248
export AR=gcc-ar
