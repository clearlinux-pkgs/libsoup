...
Source0  : https://download.gnome.org/sources/libsoup/3.2/libsoup-3.2.1.tar.xz
...
%prep
%setup -q -n libsoup-3.2.1
cd %{_builddir}/libsoup-3.2.1
pushd ..
cp -a libsoup-3.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665519028
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libsoup-3.0.so.0.6.0
/usr/lib64/libsoup-3.0.so.0
/usr/lib64/libsoup-3.0.so.0.6.0
