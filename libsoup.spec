...
Source0  : https://download.gnome.org/sources/libsoup/2.62/libsoup-2.62.0.tar.xz
...
%prep
%setup -q -n libsoup-2.62.0
pushd ..
cp -a libsoup-2.62.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1522116532
export AR=gcc-ar
