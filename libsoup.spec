...
Version  : 3.0.1
Release  : 49
URL      : https://download.gnome.org/sources/libsoup/3.0/libsoup-3.0.1.tar.xz
Source0  : https://download.gnome.org/sources/libsoup/3.0/libsoup-3.0.1.tar.xz
...
%prep
%setup -q -n libsoup-3.0.1
cd %{_builddir}/libsoup-3.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632760470
...
cp %{_builddir}/libsoup-3.0.1/COPYING %{buildroot}/usr/share/package-licenses/libsoup/ba8966e2473a9969bdcab3dc82274c817cfd98a1
...
/usr/lib64/libsoup-3.0.so.0.0.1
