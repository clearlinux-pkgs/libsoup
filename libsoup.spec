...
Source0  : https://download.gnome.org/sources/libsoup/3.4/libsoup-3.4.4.tar.xz
...
%prep
%setup -q -n libsoup-3.4.4
cd %{_builddir}/libsoup-3.4.4
pushd ..
cp -a libsoup-3.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702023640
