...
Source0  : https://download.gnome.org/sources/libsoup/2.68/libsoup-2.68.0.tar.xz
...
%prep
%setup -q -n libsoup-2.68.0
pushd ..
cp -a libsoup-2.68.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568214166
