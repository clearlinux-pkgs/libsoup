...
Source0  : https://download.gnome.org/sources/libsoup/2.56/libsoup-2.56.0.tar.xz
...
%prep
%setup -q -n libsoup-2.56.0
pushd ..
cp -a libsoup-2.56.0 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1492483106
export AR=gcc-ar
