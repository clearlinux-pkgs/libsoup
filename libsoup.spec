...
cp %{_builddir}/libsoup-2.70.0/COPYING %{buildroot}/usr/share/package-licenses/libsoup/ba8966e2473a9969bdcab3dc82274c817cfd98a1
pushd ../build32/
...
/usr/lib64/libsoup-2.4.so.1.9.0
/usr/lib64/libsoup-gnome-2.4.so.1
/usr/lib64/libsoup-gnome-2.4.so.1.9.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libsoup-2.4.so.1
/usr/lib32/libsoup-2.4.so.1.9.0
/usr/lib32/libsoup-gnome-2.4.so.1
/usr/lib32/libsoup-gnome-2.4.so.1.9.0
