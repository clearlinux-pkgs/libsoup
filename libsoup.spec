...
Source0  : https://download.gnome.org/sources/libsoup/3.0/libsoup-3.0.8.tar.xz
...
%prep
%setup -q -n libsoup-3.0.8
cd %{_builddir}/libsoup-3.0.8
pushd ..
cp -a libsoup-3.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662306124
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libsoup-3.0.so.0.0.6
/usr/lib64/libsoup-3.0.so.0
/usr/lib64/libsoup-3.0.so.0.0.6
