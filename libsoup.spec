...
%prep
%setup -q -n libsoup-2.72.0
cd %{_builddir}/libsoup-2.72.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600269524
...
cp %{_builddir}/libsoup-2.72.0/COPYING %{buildroot}/usr/share/package-licenses/libsoup/ba8966e2473a9969bdcab3dc82274c817cfd98a1
