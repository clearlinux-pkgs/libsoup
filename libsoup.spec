...
%prep
%setup -q -n libsoup-3.6.5
cd %{_builddir}/libsoup-3.6.5
pushd ..
cp -a libsoup-3.6.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742598560
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libsoup-3.0.so.0.7.4
/usr/lib64/libsoup-3.0.so.0
/usr/lib64/libsoup-3.0.so.0.7.4
