...
Source0  : https://download.gnome.org/sources/libsoup/2.58/libsoup-2.58.2.tar.xz
...
%prep
%setup -q -n libsoup-2.58.2
pushd ..
cp -a libsoup-2.58.2 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1502398693
export AR=gcc-ar
