...
Source0  : https://download.gnome.org/sources/libsoup/2.68/libsoup-2.68.2.tar.xz
...
%prep
%setup -q -n libsoup-2.68.2
pushd ..
cp -a libsoup-2.68.2 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570635454
