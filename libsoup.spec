...
Source0  : https://download.gnome.org/sources/libsoup/3.0/libsoup-3.0.0.tar.xz
...
%prep
%setup -q -n libsoup-3.0.0
cd %{_builddir}/libsoup-3.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632334525
...
cp %{_builddir}/libsoup-3.0.0/COPYING %{buildroot}/usr/share/package-licenses/libsoup/ba8966e2473a9969bdcab3dc82274c817cfd98a1
DESTDIR=%{buildroot} ninja -C builddir install
%find_lang libsoup-3.0

%files
%defattr(-,root,root,-)
/usr/lib64/python3.9/site-packages/gi/overrides/Soup.py
...
/usr/lib64/libsoup-3.0.so.0.0.0
