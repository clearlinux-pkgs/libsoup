...
Source0  : https://download.gnome.org/sources/libsoup/2.60/libsoup-2.60.3.tar.xz
...
%prep
%setup -q -n libsoup-2.60.3
pushd ..
cp -a libsoup-2.60.3 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1515512881
export AR=gcc-ar
