...
Source0  : https://download.gnome.org/sources/libsoup/2.68/libsoup-2.68.1.tar.xz
...
%prep
%setup -q -n libsoup-2.68.1
pushd ..
cp -a libsoup-2.68.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568215459
